...
(1, 'Regina', 'Dutch', 'Recruiter', 'dregina@hog.com', '402-250-8329', 'Health Oncology Group'),
(2, 'Calvin', 'Jonas', 'Project Coordinator', 'cjonas@hog.com', '714-338-2340', 'Health Oncology Group'),
(3, 'Haylie', 'Sandra', 'Data Manager', 'hsandra@hog.com', '832-209-6628', 'Health Oncology Group'),
(4, 'Steve', 'Glenna', 'M.D.', 'sglenna@case.edu', '775-981-5220', 'Case Western Reserve University'),
(5, 'Deitra', 'Gracie', 'M.D.', 'dgracie@baylor.edu', '561-552-5564', 'Baylor University Medical Center'),
(6, 'Alex', 'King', 'M.D.', 'aking@geisinger.edu', '914-774-0513', 'Geisinger Medical Center');
...
INSERT INTO `employees_supporting_clinical_trials` (`employees_employee_id`, `clinical_trials_clinical_trial_id`, `employee_role`) VALUES
(1, 'HG1141', 'Recruiter'),
...
ALTER TABLE `employees_supporting_clinical_trials`
  ...
  ADD CONSTRAINT `fk_employees_has_clinical_trials_employees1` FOREIGN KEY (`employees_employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
